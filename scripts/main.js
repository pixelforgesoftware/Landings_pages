document.addEventListener('DOMContentLoaded', () => {
    ...
    if (waFloatContainer) {
        ...
        expandedDiv.className = "absolute bottom-16 right-0 flex flex-col gap-2 items-end mb-2 animate-float";
        expandedDiv.style.display = "none";
        expandedDiv.innerHTML = `
            <a href="https://wa.me/5492625413267?text=Hola%2C%20me%20comunico%20para%20solicitar%20informaci%C3%B3n%20sobre%20los%20planes%20de%20Internet." target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 bg-white rounded-2xl shadow-xl px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-green-50 transition-colors border border-gray-100 whitespace-nowrap">
                <span class="text-green-500 font-semibold">Ventas & Admin</span>
                <span class="text-gray-400 text-xs">2625 41-3267</span>
                <div class="w-7 h-7 rounded-xl bg-green-500 flex items-center justify-center flex-shrink-0">
            ...
            <a href="https://wa.me/5492625414118?text=Hola%2C%20necesito%20asistencia%20t%C3%A9cnica%20con%20mi%20servicio%20de%20Internet." target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 bg-white rounded-2xl shadow-xl px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-orange-50 transition-colors border border-gray-100 whitespace-nowrap">
                <span class="text-orange-500 font-semibold">Guardia Técnica</span>
                <span class="text-gray-400 text-xs">2625 41-4118</span>
                <div class="w-7 h-7 rounded-xl bg-orange-500 flex items-center justify-center flex-shrink-0">
